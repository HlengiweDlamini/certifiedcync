...
router.route('/admin/certification/new').post(isAuthenticatedUser, newCertification);

//CREATE ROUTE FOR UPDATING AND DELETING CERT
router.route('/admin/certification/:id').put(isAuthenticatedUser, updateCert).delete(isAuthenticatedUser, deleteCert);
